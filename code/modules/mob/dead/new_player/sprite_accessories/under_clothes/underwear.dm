...
/datum/sprite_accessory/underwear/is_visible(obj/item/organ/organ, obj/item/bodypart/bodypart, mob/living/carbon/owner)
	if(hides_breasts)
		if(is_human_part_visible(owner, HIDEUNDIESBOT) || is_human_part_visible(owner, HIDEUNDIESTOP))
			return TRUE
	return is_human_part_visible(owner, HIDEUNDIESTOP)
...
/datum/sprite_accessory/legwear
	...
	icon = 'modular_rmh/icons/mob/sprite_accessory/stockings.dmi'
